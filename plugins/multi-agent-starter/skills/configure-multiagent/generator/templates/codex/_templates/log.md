...
형식 예시 (이 블록은 사용 시 삭제)
========================================
[2026-06-01 14:30] [DECISION] routing.md 참조 -> claude-main + codex-main + codex-critic 선택. gemini 제외 (시각 자료 없음)
[2026-06-01 14:31] [APPROVAL] codex-main 사용자 승인. purpose: WordPress 반영 및 로컬 검증
...
[2026-06-01 15:11] [DECISION] codex-critic 호출 결정. 애드센스 정책·결함 비평 필요
